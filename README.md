...
- 🔭 Currently working as a *Software Test Engineer at NuralTech Pvt Ltd*

- 🧪 3+ years of experience in *Manual & Automation Testing* of SaaS, DMS, Web, API and Mobile applications

- 📱 Hands-on with *Mobile App Testing on Android & iOS* devices

- ⚙️ Building automation frameworks with *Selenium WebDriver (Java), TestNG, Maven, Apache POI*

- 🔗 API Testing with *Postman* | Database validation with *SQL*

- 💬 Ask me about *Selenium, Java, Manual Testing, API Testing, SQL, JIRA*
